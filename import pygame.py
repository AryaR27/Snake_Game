...
# Game Title
pygame.display.set_caption("Snakes-L1")
...
def gameloop():
    ...
    food_x = random.randint(20, screen_width *0.9)
    food_y = random.randint(20, screen_height *0.9)
    score = 0
    init_velocity = 5
    snake_size = 30
    fps = 60
    while not exit_game:
        if game_over:
            ...
            text_screen("Game Over! Press SPACE BAR To Continue", red, 100, 250)
            ...
            text_screen("Score: " + str(score) + "  Hiscore: "+str(hiscore), red, 275, 5)
